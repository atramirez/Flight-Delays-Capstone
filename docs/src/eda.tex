% The % symbol means this is a comment!

%Define document class: e.g. article, book, or beamer (for beamer presentations, which are similar to powerpoint)
%Usually article is the default
%The options in brackets allow you to define the page type, type size, etc.
\documentclass[a4paper,11pt]{article}

%Include various packages to extend capabilities
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
